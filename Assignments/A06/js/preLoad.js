...
var preLoad = {
	preload:function(){
		...
		//game.load.atlas('enemy_atlas', 'asstes/sprites/enemy_atlas.png', 'assets/sprites/enemy_atlas.json')
		game.load.atlas('red_portal_atlas', 'assets/sprites/red_portal.png', 'assets/sprites/red_portal.json')
		...
		game.load.spritesheet('coin', 'assets/sprites/coinAnimated', 37, 36)
		// load audio here: 
		//////////////////////////////////////////////////////
