...
function Player (game_copy) {
     ...
     */
    this.create = function (x, y, x_scale, y_scale, id) {
        ...
        this.ship.data['lockKeys'] = false
        this.ship.data['health'] = 500
        this.ship.data['max_health'] = 500
    ...
    this.makePlayer = function (x, y) {
        this.ship = game.add.sprite(x, y, 'ufo');
        this.ship.animations.add('hover');
        //console.log(this.ship)
        
        this.ship.animations.play('hover', 7, true);
    ...
    this.move = function(){
        if (this.ship.data['lockKeys'] == false) {
    ...
    this.fireBullets = function () {
        ...
        if (bullet) {
            ...
            bullet.reset(this.ship.x, this.ship.y + 56);
